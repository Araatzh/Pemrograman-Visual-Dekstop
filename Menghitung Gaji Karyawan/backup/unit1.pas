...
begin
  try
    ...
    edtTotalGaji.Text:= CurrToStr(hasil);
      ...
      ShowMessage('Nama,Status, dan Jabatan harus diisi!');
  end;
...
begin
  ...
  if('Direktur'.Equals(jabatan))then edtGapok.Text:='5000000'
  else
  if('Manajer'.Equals(jabatan))then edtGapok.Text:='3000000'
  else
  if('Karyawan'.Equals(jabatan))then edtGapok.Text:='1000000'
  else
...
begin
  if(Status.ItemIndex = -1) then edtTunjangan.Text:= '0'
  else
  if(Status.ItemIndex= 0) then edtTunjangan.Text:= '15000000'
  else
  if(Status.ItemIndex = 1)then edtTunjangan.Text:= '5000000'
  else
end;
